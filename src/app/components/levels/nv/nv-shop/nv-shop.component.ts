...
@Component({
  ...
  templateUrl: './nv-shop.component.html',
  styleUrl: './nv-shop.component.scss'
})
export class NvShopComponent implements OnDestroy {

  readonly dialogRef = inject(MatDialogRef<NvShopComponent>);
  selectedItem: any;
