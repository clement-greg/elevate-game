...
@Component({
  selector: 'app-tx-shop',
  standalone: true,
  imports: [CommonModule, PriceTagComponent, PressAComponent, LottiePlayerComponent],
  templateUrl: './tx-shop.component.html',
  styleUrl: './tx-shop.component.scss'
})
export class TxShopComponent implements OnDestroy {

  readonly dialogRef = inject(MatDialogRef<TxShopComponent>);
  selectedItem: any;
